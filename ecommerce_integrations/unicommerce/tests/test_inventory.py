...
class TestUnicommerceProduct(TestCaseApiClient):
	...
	def setUpClass(cls):
		...
		with patch("ecommerce_integrations.shopify.product.upload_draerp_item"):
	...
	def test_inventory_sync(self):
		...
		# create stock entries for warehouses (warehouses are part of before_test hook in draerp)
