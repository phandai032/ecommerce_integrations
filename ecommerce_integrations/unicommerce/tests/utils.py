...
class TestCase(unittest.TestCase):
	config = {
		...
		"warehouse_mapping": [
			{"unicommerce_facility_code": "Test-123", "draerp_warehouse": "Stores - WP", "enabled": 1},
			{"unicommerce_facility_code": "B", "draerp_warehouse": "Work In Progress - WP", "enabled": 1},
		],
	}
	...
	def setUpClass(cls):
		...
		for wh_map in settings.warehouse_mapping:
			keys_to_retain = ["unicommerce_facility_code", "draerp_warehouse", "enabled"]
