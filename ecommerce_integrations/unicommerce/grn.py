...
import frappe
from draerp.stock.doctype.batch.batch import Batch
...
def get_facility_code(stock_entry, unicommerce_settings) -> str:
	...
	warehouse_mapping = unicommerce_settings.get_draerp_to_integration_wh_mapping(all_wh=True)
...
def _prepare_grn_import_csv(stock_entry) -> str:
	...
	for item in stock_entry.items:
		...
		sku = frappe.db.get_value(
			"Ecommerce Item",
			{"draerp_item_code": item.item_code, "integration": MODULE_NAME},
