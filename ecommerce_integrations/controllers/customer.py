...
class EcommerceCustomer:
	...
	def sync_customer(self, customer_name: str, customer_group: str) -> None:
		"""Create customer in DraERP if one does not exist already."""
	...
	def create_customer_address(self, address: Dict[str, str]) -> None:
		"""Create address from dictionary containing fields used in Address doctype of DraERP."""
	...
	def create_customer_contact(self, contact: Dict[str, str]) -> None:
		"""Create contact from dictionary containing fields used in Address doctype of DraERP."""
