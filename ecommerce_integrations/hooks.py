...
app_description = "Ecommerce integrations for DraERP"
...
doc_events = {
	"Item": {
		"after_insert": "ecommerce_integrations.shopify.product.upload_draerp_item",
		"on_update": "ecommerce_integrations.shopify.product.upload_draerp_item",
		"validate": [
